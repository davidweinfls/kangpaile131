...
public static final String error8a_CompileTime  =
  "Initialization value of global/static variable named %S not known at compile time.";

public static final String error8b_CompileTime  =
